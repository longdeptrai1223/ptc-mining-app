...
// Firestore Admin
export const firestore = firebaseAdmin ? getFirestore(firebaseAdmin) : null;

// Firebase Cloud Messaging Admin
export const messaging = firebaseAdmin ? getMessaging(firebaseAdmin) : null;
...
export async function sendPushNotification(
  ...
  if (!messaging) {
    throw new Error("Firebase Messaging Admin not initialized");
  }
